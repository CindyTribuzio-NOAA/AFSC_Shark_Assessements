...
conditionalPanel(
  ...
  conditionalPanel(
    ...
    # fluidRow(column(3, uiOutput("stock.M")),column(3, uiOutput("stock.M2")),column(3, uiOutput("stock.Msd")),column(3, uiOutput("stock.Mgrad"))),
    ...
    fluidRow(column(6, uiOutput("stock.M")),column(6, uiOutput("stock.Msd"))),
    fluidRow(column(6, uiOutput("stock.Linf")),column(6, uiOutput("stock.Linfsd"))),
    fluidRow(column(6, uiOutput("stock.K")),column(6, uiOutput("stock.Ksd"))),
    ...
    fluidRow(column(6, uiOutput("stock.h"))),
...
#    fluidRow(column(6, uiOutput("fleet.Rmaxlen")),column(6, uiOutput("fleet.DR")))),
    ...
    fluidRow(column(6, uiOutput("Obs.Mbiascv")),column(6, uiOutput("Obs.hbiascv"))),
    fluidRow(column(6, uiOutput("Obs.Linfbiascv")),column(6, uiOutput("Obs.Kbiascv"))),
    fluidRow(column(6, uiOutput("Obs.t0biascv")),column(6, uiOutput("Obs.LenMbiascv"))),
    #fluidRow(column(6, uiOutput("Obs.Recbiascv")),column(6, uiOutput("Obs.FMSYbiascv"))),
    fluidRow(column(6, uiOutput("Obs.Recbiascv"))),
    fluidRow(column(6, uiOutput("Obs.FMSY_Mbiascv")),column(6, uiOutput("Obs.BMSY_B0biascv"))),
#    fluidRow(column(6, uiOutput("Obs.Fcurbiascv")),column(6, uiOutput("Obs.Fcurcv"))),
    fluidRow(column(6, uiOutput("Obs.LFCbiascv")),column(6, uiOutput("Obs.LFSbiascv"))),
    ...
    #fluidRow(column(6, uiOutput("")),column(6, uiOutput(""))),
    fluidRow(column(6, uiOutput("Obs.Iobs")),column(6, uiOutput("Obs.Ibiascv"))),
    fluidRow(column(6, uiOutput("Obs.Dbiascv")),column(6, uiOutput("Obs.Dobs"))),
    #fluidRow(column(6, uiOutput("Obs.Btbiascv")),column(6, uiOutput("Obs.Btobs"))),
    fluidRow(column(6, uiOutput("Obs.beta")),column(6, uiOutput("Obs.Irefbiascv"))),
    fluidRow(column(6, uiOutput("Obs.Brefbiascv")),column(6, uiOutput("Obs.Crefbiascv")))),
